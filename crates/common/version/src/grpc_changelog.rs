...
pub fn grpc_changelog() -> BTreeMap<Version, GrpcVersionCompat> {
    ...
    // 260312.2.0: no compatibility change
    m.insert(ver(260312, 2, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260312.3.0: no compatibility change
    m.insert(ver(260312, 3, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260312.4.0: no compatibility change
    m.insert(ver(260312, 4, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260312.5.0: no compatibility change
    m.insert(ver(260312, 5, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });
    ...
    // 260312.10.0: no compatibility change
    m.insert(ver(260312, 10, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });
    ...
    // 260428.2.0: no compatibility change
    m.insert(ver(260428, 2, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });
    ...
    // 260512.3.0: no grpc compatibility change.
    m.insert(ver(260512, 3, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });
    ...
    // 260628.0.0: no grpc compatibility change.
    m.insert(ver(260628, 0, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });
    ...
    // 260629.0.0: no grpc compatibility change.
    m.insert(ver(260629, 0, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260629.1.0: no grpc compatibility change.
    m.insert(ver(260629, 1, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260629.2.0: no grpc compatibility change.
    m.insert(ver(260629, 2, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260629.3.0: no grpc compatibility change.
    m.insert(ver(260629, 3, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260629.4.0: no grpc compatibility change.
    m.insert(ver(260629, 4, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260629.5.0: no grpc compatibility change.
    m.insert(ver(260629, 5, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260629.6.0: no grpc compatibility change.
    m.insert(ver(260629, 6, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

    // 260629.7.0: no grpc compatibility change.
    m.insert(ver(260629, 7, 0), GrpcVersionCompat {
        min_client: ver(1, 2, 676),
        min_server: ver(260217, 0, 0),
    });

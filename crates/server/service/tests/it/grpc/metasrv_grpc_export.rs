...
async fn test_export() -> anyhow::Result<()> {
    ...
    let want = vec![
        ...
        r#"["raft_log",{"LogEntry":{"log_id":{"leader_id":{"term":1,"node_id":0},"index":4},"payload":{"Normal":{"time_ms":1111111111111,"cmd":{"Transaction":{"condition":[{"key":"foo","expected":2,"target":{"Seq":0}}],"if_then":[{"request":{"Put":{"key":"foo","value":[102,111,111],"prev_value":true,"expire_at":null,"match_seq":null}}}],"else_then":[{"request":{"Get":{"key":"foo"}}}]}}}}}}]"#,
        r#"["raft_log",{"LogEntry":{"log_id":{"leader_id":{"term":1,"node_id":0},"index":5},"payload":{"Normal":{"time_ms":1111111111111,"cmd":{"Transaction":{"condition":[{"key":"bar","expected":2,"target":{"Seq":0}}],"if_then":[{"request":{"Put":{"key":"bar","value":[98,97,114],"prev_value":true,"expire_at":null,"match_seq":null}}}],"else_then":[{"request":{"Get":{"key":"bar"}}}]}}}}}}]"#,
        r#"["raft_log",{"LogEntry":{"log_id":{"leader_id":{"term":1,"node_id":0},"index":6},"payload":{"Normal":{"time_ms":1111111111111,"cmd":{"Transaction":{"condition":[{"key":"wow","expected":2,"target":{"Seq":0}}],"if_then":[{"request":{"Put":{"key":"wow","value":[119,111,119],"prev_value":true,"expire_at":null,"match_seq":null}}}],"else_then":[{"request":{"Get":{"key":"wow"}}}]}}}}}}]"#,
